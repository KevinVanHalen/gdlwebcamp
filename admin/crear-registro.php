            ...
            <div class="col-md-8">
                ...
                <section class="content">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                        <!-- form start -->
                            <form role="form" name="guardar-registro" id="guardar-registro" method="post" action="modelo-crear-registro.php">
                                <div class="box-body">
                                                        ...
                                                        <?php foreach($eventos['eventos'] as $tipo => $evento_dia): ?>
                                                            <div class="col-md-4">
                                                                ...
                                                                <?php foreach($evento_dia as $evento) { ?>
                                                                    <label>
                                                                        <input type="checkbox" class="flat-blue" name="registro_evento[]" id="<?php echo $evento['id']; ?>" value="<?php echo $evento['id']; ?>">
