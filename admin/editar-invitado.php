            ...
            <div class="col-md-8">
                ...
                <section class="content">
                    ...
                    <div class="box">
                        ...
                        <!-- form start -->
                            <form role="form" name="guardar-registro" id="guardar-registro-archivo" method="post" action="modelo-editar-invitado.php" enctype="multipart/form-data">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="" type="file" id="imagen_invitado" name="archivo_imagen">
