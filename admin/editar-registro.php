            ...
            <div class="col-md-8">
                ...
                <section class="content">
                    ...
                    <div class="box">
                        ...
                        ?>
                        <!-- form start -->
                            <form class="editar-registrado" role="form" name="guardar-registro" id="guardar-registro" method="post" action="modelo-editar-registro.php">
                                <div class="box-body">
                                                ...
                                                <li class="col-md-4">
                                                    <div class="tabla-precio text-center">
                                                        ...
                                                        <div class="orden">
                                                            ...
                                                            <input value="<?php echo $boletos['un dia']['cantidad']; ?>" type="number" class="form-control" min="0" id="pase_dia" size="3" name="boletos[un_dia][cantidad]" placeholder="0">
                                                        ...
                                                        <?php foreach($eventos['eventos'] as $tipo => $evento_dia): ?>
                                                            <div class="col-md-4">
                                                                ...
                                                                <?php foreach($evento_dia as $evento) { ?>
                                                                    <label>
                                                                        <input <?php echo (in_array($evento['id'], $id_eventos_registrados['eventos']) ? 'checked' : '' ); ?> type="checkbox" class="flat-blue" name="registro_evento[]" id="<?php echo $evento['id']; ?>" value="<?php echo $evento['id']; ?>">
